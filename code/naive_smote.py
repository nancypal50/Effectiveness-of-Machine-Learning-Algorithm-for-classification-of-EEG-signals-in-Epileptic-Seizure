...
if __name__ == '__main__':
    ...
    print("NAIVE BAYES ", str(acc_gnb) + '%')


    print(confusion_matrix(y_test, y_pred_gnb, labels=[1, 0]))
    CM = confusion_matrix(y_test, y_pred_gnb, labels=[1, 0])
    ...
    f1 = f1_score(y_test, y_pred_gnb, zero_division=1)
    print("F1 SCORE ", f1)
